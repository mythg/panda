...
const (
	...
	indexOperatorNotSupportedError = "index operator not supported"
	unUsableAsHashKeyError         = "unusable as hash key"
)
...
func evalIndexExpression(left, index object.Object) object.Object {
	...
	default:
		return newError("%s: %s", indexOperatorNotSupportedError, left.Type())
	}
}
...
func evalHashIndexExpression(hash, index object.Object) object.Object {
	...
	if !ok {
		return newError("%s: %s", unUsableAsHashKeyError, index.Type())
	}
